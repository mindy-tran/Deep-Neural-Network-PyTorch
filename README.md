...
Machine Learning project: Implement two deep feed-forward neural networks in PyTorch, treating the identification of handwritten numbers from the MNIST dataset as a regression problem and a classification problem.
